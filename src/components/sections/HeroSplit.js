            ...
            <div className={splitClasses}>
              <div className="split-item" style={inlineStyle()}>
                <div className="hero-content split-item-content center-content-mobile">
                  ...
                  The new addictive way to save. Our pool rewards savers that hit their targets with higher interest rates.<br/>Start building the financial habits you deserve today.
